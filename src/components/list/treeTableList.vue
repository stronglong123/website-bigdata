    ...
    <div id="components-form-search">
        ...
        <el-row :gutter="10">
            ...
            <template v-for="(item, index) in searchItems">
                <el-col :span="4" :style="{ display: index < count ? 'block' : 'none' }">
            ...
            <el-col :span="4" style="text-align: right;padding-right:10px;margin:4px 0;">
        ...
        <div class="search-result-list">
            ...
            <div class="search-result-list">
                <a-tabs :activeKey="activeKey" @change="activeTab" type="card">
                    <template v-for="(tab,index) in panes">
                        <a-tab-pane :tab="tab.name" :key="index">
                            <el-table :data="dataList" height="480" fit size="medium"  @selection-change="handleSelectionChange"
                                      row-key="id"
        ...
        methods:{
            ...
            emitSearch(type) {
                ...
                this.form.validateFields((error, values) => {
                    if (!error) {
                        this.$emit(`search`,{...values, ...pageParams,appId:this.appId})
                    }
                })
            },
            handleInput(e) {
            ...
            activeTab(key) {
                ...
                const tab = this.panes[key];
                if (key !== undefined) {
                    this.activeKey = key;
                }
                this.appId = tab.appId;
                this.$emit(`appId`,{appId:this.appId});
                this.emitSearch(this.pageName)
            },
        }
    }
